...
class Testconnectors134535ViewSet(BaseConnectorViewSet):
    PASSWORD = settings.CONNECTOR_TESTCONNECTORS134535_PASSWORD
    USERNAME = settings.CONNECTOR_TESTCONNECTORS134535_USERNAME
    BASE_URL = "https://devstringx.com"
    AUTH_TYPE = "basic"
    IDENTIFIER = "CONNECTOR_TESTCONNECTORS134535"
